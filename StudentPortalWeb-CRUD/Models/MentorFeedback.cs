namespace StudentPortalWeb_CRUD.Models
{
    public class MentorFeedback
    {
        ...
        public int WeekNumber { get; set; }  // Week number for the feedback (e.g., Week 1, Week 2)

        public double SoftSkillsScore { get; set; }  // Soft Skills score (1-5)
        public double TechnicalSkillsScore { get; set; }  // Technical Skills score (1-5)
        public double TimelinessScore { get; set; }  // Timeliness score (1-5)

        public string FeedbackNotes { get; set; }  // Mentor's feedback on the intern's performance in that week
